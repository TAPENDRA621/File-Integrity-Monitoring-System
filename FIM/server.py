...
if __name__ == "__main__":
    # allow_unsafe_werkzeug=True is required when running directly with
    # `python server.py` (dev only). In Docker/production, Gunicorn is used
    # via wsgi.py and this block is never reached.
